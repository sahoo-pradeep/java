...
public class ProductController {
     ...
     * @return          A ResponseBody that contains the updated Product or one of the error:
     *                  Conflict if product version doesn't match with eTag
     *                  Not Found if the product with ID is not found in database
     *                  Internal Server Error if there is problem creating location URI
     */
     ...
     * @return      A ResponseBody with one of the following status codes:
     *              200 OK if the delete is successful
     *              404 Not Found if a product with specified ID is not found
